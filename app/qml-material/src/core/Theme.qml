...
Object {
    ...
    */
    ...
    property bool isDark: isDarkColor(backgroundColor)
    property color textColor: isDark ? dark.textColor : light.textColor
    property color subTextColor: isDark ? dark.subTextColor : light.subTextColor
    property color dividerColor: isDark ? dark.dividerColor : light.dividerColor
    property color hintColor: isDark ? dark.hintColor : light.hintColor
