...
QtObject {
    ...
    property color backgroundShade: backgroundColor
    property string dialogColor: backgroundColor
    property string tabHighlightColor

    property string contrastColor: "white"
    ...
    onFontFamilyChanged: Theme.fontFamily = appTheme.fontFamily
