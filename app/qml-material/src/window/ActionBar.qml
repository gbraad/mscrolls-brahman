...
Item {
    ...
    implicitHeight: Device.gridUnit * Units.dp
    ...
    // VW CHANGE
    property alias customContentLoader: __customContentLoader
     ...
     */
    property int maxActionCount: Math.max((width - label.width - label.lmargin - stdMargin*2 + actionsRow.spacing)/(iconSize + actionsRow.spacing), 1)
    ...
    property int barMargin: 8*Units.dp
    ...
    IconButton {
        ...
        anchors {
            ...
            topMargin: barMargin
            left: parent.left
            leftMargin: leftItem.show ? stdMargin : -leftItem.width
    ...
    Label {
        ...
        property int lmargin: stdMargin + (leftItem.show ? Device.gridUnit * Units.dp : 0)
        ...
        // VW CHANGE
        //visible: customContentView.children.length === 0 && (!integratedTabBar || !tabBar.visible)
        visible: !customContentLoader.active && (!integratedTabBar || !tabBar.visible)
    ...
    Row {
        ...
        Repeater {
            model: overflowMenuAvailable ? maxActionCount - 1
    ...
    Dropdown {
        ...
        width: 250 * Units.dp
        height: columnView.height + stdMargin
    ...
    {
        // VW CHANGE
        // code to allow actionbar to drag root window. eg for frameless
        anchors.fill: parent
