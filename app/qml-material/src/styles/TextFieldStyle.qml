...
TextFieldStyle {
    ...
    font {
        family: echoMode == TextInput.Password ? "Default" : Theme.fontFamily
        pixelSize: control.fontSize
    }
    ...
    background : Item {
        ...
        Label {
            ...
            color: background.hasError ? background.errorColor
                                  : control.activeFocus && control.text !== ""
                                        ? background.color : Theme.hintColor
        ...
        RowLayout {
            ...
            Label {
                ...
                font.pixelSize: 12 * Units.dp
                color: background.hasError ? background.errorColor : Theme.hintColor
