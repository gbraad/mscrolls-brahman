...
* and it will have to leave
	...
	CLR.W	D0			;print mode
	CALL	AtStation		;we'l let the player know if he is
...
MoveWitch:
	MOVE.L	WitchPlace(A4),A3		; where the witch is ?
	CMP.L	#0,A3			; has it been done?	
	BNE.S	10$			; no witch yet...
	LEA	WitchBizz(PC),A3	; okay start her off...
10$
...
AshesonHearth
	MOVE.W	#NASH,D0
	GETINFO
	CMP.L	#REL.MASK+NHEARTH,6(A0)	; test the state...
	RET
