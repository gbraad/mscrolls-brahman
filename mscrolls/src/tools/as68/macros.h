...
#define MAXMACROSIZE	1000
#define MAXMACRODEPTH	20
#define MAXMACROARGS	20
#define MAXMACROARGLEN	50
...
struct macro
{
	inttype len;			/* number of chars in macro */
	char *space;		/* ptr to space reserved for macro */
};
