...
extern char label_field[];
extern char opcode_field[];
extern char operand_field[];
extern char *operand_ptr;
extern struct symbol *opcode_symbol;

#define getline lgetline
