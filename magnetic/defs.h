...
#define ITEM_MAX_ADJ    4
#define ITEM_MAX_EXITS  12

typedef struct 
{ 
    Word                word; // NB: this has to be first
    int                 id;
    int                 adj[ITEM_MAX_ADJ];
    unsigned char*      data;
    unsigned char*      exitData;  // for rooms
    unsigned char*      npcData; // if NPC
} Item;
...
{
    type32      magic;
    type32      datafile_size; // 4
    type32      header_size;  // 8 - should be 42 for org. interpreter
    type8       gameid; // 12
    type8       version; // 13
    type32      code_size; // 14
    type32      string_size; // 18
    type32      string2_size; // 22
    type32      dict_size; // 26
    type32      dec; // 30
    type32      undo_size; // 34
    type32      undo_pc; // 38
...
extern Item* items;
extern size_t itemCount;

extern Word* adjectives;
extern size_t adjectiveCount;
extern size_t maxRoom;
extern size_t bytesPerRoom;
extern size_t npcCount;

Item* find_item(int n);
Word* find_adjective(int n);

int msg_write_string(int, outfn);

extern void init_items();
extern type16 get_current_room();
extern type16 set_current_room(type16 v);
extern type16 get_game();
...
extern void* create_dasm();
extern void dasm_addins(void*,void*);
extern void* create_ins();
extern void ins_setaddr(void*, int);
extern void ins_setop(void*, char*);
extern void ins_setopsize(void*,char*);
extern void ins_appendarg1(void*, char*);
extern void ins_appendarg2(void*, char*);
extern void ins_setarg1(void*, char*);
extern void ins_setarg2(void*, char*);
extern void ins_appendcomment(void*, char*);
extern void ins_setsize(void*, int);
extern void ins_setcode(void*, int append, char *);
extern void dasm_dump(void*, const char*);
extern void dasm_fillgaps(int*,int,const char*);
extern void dasm_jmp_reset(void*, const char*);
extern void dasm_listgaps(void*);
extern type8 *effective(type32 ptr);
extern int dasm_nextgap(void*);
extern int dasm_gapend(void*);
#endif
