...
kwTable kw_table[] =  {
  ...
  {.keyword_eng = "ALL_LOCS", .keyword_nl = "ALLE_PLAATSEN"},
  ...
  {.keyword_eng = "HYBRID", .keyword_nl = "HYBRIDE"},    /* @!@ */
  ...
  {.keyword_eng = "OFF", .keyword_nl = "UIT"},
  {.keyword_eng = "ON", .keyword_nl = "AAN"},
  ...
  {.keyword_eng = "OVERRULE_VERB", .keyword_nl = "VERVANG_WERKWOORD"},
  ...
  {.keyword_eng = "SPECIFIER", .keyword_nl = "DING2"},
  ...
  {.keyword_eng = "SUBJECT", .keyword_nl = "DING1"},
