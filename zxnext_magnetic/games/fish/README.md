...
1. On your PC, unpack the downloaded ZIP file fish.zip on an SD card containing
...
```
> CSpect.exe -w4 -tv -zxnext -mmc=<fish>/ <fish>/fish_512.nex
```
...
> zesarux.exe --noconfigfile --machine tbblue --enabletimexvideo
  ...
  --enable-esxdos-handler --esxdos-root-dir <fish> <fish>/fish_512.nex
```
