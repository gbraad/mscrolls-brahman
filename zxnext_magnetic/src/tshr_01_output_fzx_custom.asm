...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
; This output terminal driver subclasses the tshr_01_output_fzx
; driver.
;
...
IF USE_GFX
   ...
   call image_key_scroll       ; image scroll for up/down
...
IF USE_GFX
   ...
   call image_height_in_chars       ; a = height of image in characters

   sub TEXT_WINDOW_HEIGHT
   neg                              ; a = TEXT_WINDOW_HEIGHT - image_height_in_chars
...
IF USE_GFX
   ...
   sub c
   neg                              ; a = (y + 1) - image_height_in_chars
