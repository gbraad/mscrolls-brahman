 ...
 * Stefan Bylund 2018
 *
 * Limited C API for using the hardware sprites of the Sinclair ZX Spectrum Next
 * for displaying the status bar, a scroll prompt and a mouse pointer by the
 * Magnetic Scrolls interpreter interface.
 ******************************************************************************/
