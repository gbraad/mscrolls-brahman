...
;
; The game mode can be toggled between remastered and classic
; mode by pressing BREAK (CAPS+SPACE).
;
; ;;;;;;;;;;;;;;;;;;;;
...
EXTERN l_jpix
EXTERN image_key_scroll
EXTERN cycle_text_color
EXTERN _switch_game_mode
...
defc ASCII_CODE_TRUE_VIDEO = 128
defc ASCII_CODE_INV_VIDEO = 129
...
IF USE_GFX = 0
   ...
   ret
ELSE
   jp image_key_scroll         ; sets carry flag correctly for up/down rejection
ENDIF

IF USE_PROG_FORMAT
handle_switch_game_mode:
IF __SDCC_IY
   push iy
   call _switch_game_mode
   pop iy
ELSE
   push ix
   call _switch_game_mode
