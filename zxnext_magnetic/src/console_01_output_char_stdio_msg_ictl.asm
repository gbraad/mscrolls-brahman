; Bug fix in _ioctl_scroll_limit routine, clear carry flag.
...
IF __SDCC_IY
   ld e,(iy+14)                ; e = x_coord
   ld d,(iy+15)                ; d = y_coord
ELSE
...
IF __SDCC_IY
   ld (iy+20),a                ; set scroll_limit to zero
ELSE
